...
export default function Kalkulacka() {
    ...
    const countTimeWhenSober = useCallback((totalAlcoholInBody, alcoholPerHour) => {
    ...
    const setDrink = useCallback((selectedDrinkId, count = 1) => {
            ...
            <section className="flex flex-col gap-12">
                ...
                {perMile > 0 && (
                    <article>
                        ...
                        <p>Máte v krvi zhruba {perMile} promile alkoholu.</p>
                        <p>Střízliví byste měli být v: {soberTime.format("HH:mm")}</p>
                    </article>
                )}
